...
internal extension PageboyViewController {
    ...
    private func _updateViewControllers(to viewControllers: [UIViewController],
        ...
        let updateBlock = { [weak self, direction, animateUpdate, viewControllers, animated, isUsingCustomTransition] in
            ...
            pageViewController.setViewControllers(viewControllers, direction: direction.layoutNormalized(isRtL: sSelf.contentView.layoutIsRightToLeft).rawValue,
...
internal extension PageboyViewController {
    ...
    internal func setUpPageViewController(reloadViewControllers: Bool = true) {
        ...
        if let existingZIndex = existingZIndex {
            ...
            #if swift(>=4.2)
            self.contentView.sendSubviewToBack(pageViewController.view)
            #else
